...
# Main Inputs
"""
bgra_input_1 = Input(shape=(250, 1080, 1920, 4),
                     dtype='float32',
                     name='bgra_input_1')
bgra_input_2 = Input(shape=(250, 1080, 1920, 4),
                     dtype='float32',
                     name='bgra_input_2')
depth_input_1 = Input(shape=(250, 424, 512, 1),
                      dtype='float32',
                      name='depth_input_1')
depth_input_2 = Input(shape=(250, 424, 512, 1),
                      dtype='float32',
                      name='depth_input_2')
...
conc_out = concatenate([
    ...
    depth_input_2_conv, skeletxt_input_1, skeletxt_input_2
])
...
# Model Definition
model = Model(inputs=[
    bgra_input_1, depth_input_1, skeletxt_input_1, bgra_input_2, depth_input_2,
    skeletxt_input_2
],
              outputs=[main_output])
